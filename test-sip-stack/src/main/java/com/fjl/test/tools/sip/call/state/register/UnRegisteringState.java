...
public class UnRegisteringState extends SipDialogState {
    ...
    public void handleRegisterSuccessResponse(SipDialog sipDialog,
        ...
        logger.trace("UnregisteringState.handleRegisterSuccessResponse");
    ...
    public void handleRegisterErrorResponse(SipDialog sipDialog,
            ...
            throws SipClientStackException {
        logger.trace(
                "UnregisteringState.handleRegisterErrorResponse: Status code is: {}",
