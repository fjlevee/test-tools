...
import fj_levee.test.parser.SipTestCallFlowUtils;
	...
	public class RequestUriElement
	{
	  ...
	  public void parseElement(MessageElement messageElement,org.w3c.dom.Node element)throws SipClientParserException{
	    ...
	    try{
	      ...
	      this.value = value;
	    	...
	    	throw new SipClientParserException("RequestUriElement.parseXmlCallFlowElement: name attribute can not be null");
	    } 
