...
public class ResponseUriElement
{
   ...
   */
  public void parseElement ( MessageElement messageElement, org.w3c.dom.Node responseUriElement)
      throws SipClientParserException
  {

    // Get the xmlCallFlowElement attributes
    org.w3c.dom.NamedNodeMap xmlCallFlowNodesAttributes = responseUriElement.getAttributes();

    // Param name.
    try
    {
      String value = xmlCallFlowNodesAttributes.getNamedItem( SipTestCallFlowUtils.VALUE_ATTRIBUTE).getNodeValue();
      this.value = value;
    }
