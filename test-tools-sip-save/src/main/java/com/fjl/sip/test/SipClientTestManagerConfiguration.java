...
public class SipClientTestManagerConfiguration
{
   ...
   * Log4j logger
   */
  private Logger logger = Logger.getLogger( com.fjl.sip.test.SipClientTestManagerConfiguration.class);
   ...
   */
  //public static String ACTION_MIN_WAIT_TIME_SEND_MESSAGE = "client.tester.action.min.wait.time.send.message";
  /**
   * ACTION_MIN_WAIT_TIME_SEND_ACK_MESSAGE
   */
  //public static String ACTION_MIN_WAIT_TIME_SEND_ACK_MESSAGE = "client.tester.action.min.wait.time.send.ack.message";
  /**
   * ACTION_MIN_WAIT_TIME_RECEIVE_MESSAGE
   */
  //public static String ACTION_MIN_WAIT_TIME_RECEIVE_MESSAGE = "client.tester.action.min.wait.time.receive.message";
  ...
  private SipClientTestManagerConfiguration ()
  {
    ...
    try
    {
      testClientConfiguration = new PropertiesConfiguration( SIP_CLIENT_TEST_LAUNCHER_PROPERTIES);
      testClientConfiguration.setAutoSave( true);
      
    }
    catch (ConfigurationException e)
    {
      logger.error( "SipClientTestManagerConfiguration constructor ConfigurationException Error: " + e.getMessage());
    }
  }
  ...
  public static String getStringParameter ( String parameterName,String defaultValue)
  {
    ...
    return instance.testClientConfiguration.getString( parameterName,defaultValue);
  }
  /**
   * getLongParameter
   * 
  ...
  public static long getLongParameter ( String parameterName,long defaultValue)
  {
    ...
    return instance.testClientConfiguration.getLong( parameterName,defaultValue);
  }
  /**
   * getLongParameter
   * 
  ...
  public static int getIntParameter ( String parameterName,int defaultValue)
  {
    ...
    return instance.testClientConfiguration.getInt( parameterName,defaultValue);
  }
  /**
   * getIntParameter
   * 
