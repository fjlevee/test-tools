...
public class MessageElement {
    ...
    private Logger logger = Logger
            .getLogger(com.fjl.test.xml.parser.elements.MessageElement.class);
    ...
    public void parseElement(SipRequestElement requestElement,
            org.w3c.dom.Node messageElement) throws SipClientParserException {
        parse(messageElement);
        requestElement.setMessageElement(this);
    }

    public void parseElement(SipResponseElement responseElement,
            org.w3c.dom.Node messageElement) throws SipClientParserException {
        parse(messageElement);
     ...
     */
    private void parse(org.w3c.dom.Node messageElement)
            throws SipClientParserException {
        // Get the xmlCallFlowElement attributes
        // org.w3c.dom.NamedNodeMap xmlCallFlowNodesAttributes =
        // xmlCallFlowSubElement.getAttributes();
        ...
        for (int i = 0; i < children.getLength(); i++) {
            ...
            if (child.getNodeType() == org.w3c.dom.Node.ELEMENT_NODE) {
                if (SipTestCallFlowUtils.REQUEST_URI_ELEMENT == child
                        .getNodeName()) {
                    RequestUriElement element = new RequestUriElement();
                    element.parseElement(this, child);
                } else if (SipTestCallFlowUtils.RESPONSE_URI_ELEMENT == child
                        .getNodeName()) {
                    ResponseUriElement element = new ResponseUriElement();
                    element.parseElement(this, child);
                } else if (SipTestCallFlowUtils.HEADER_ELEMENT == child
                        .getNodeName()) {
                    HeaderElement element = new HeaderElement();
                    element.parseElement(this, child);
                    // Check if the Header was a Content Header
                    if (SipTestCallFlowUtils.CONTENT_HEADER.equals(element
                            .getName())) {
     ...
     * 
     * @param method
     *            specifies the method of this Sip Message
     ...
     * 
     * @param header
     *            specifies the header to be Added
     */
    ...
    public Content getContent() {
        ...
        if (content != null) {
            ...
            if (contentTypeHeader != null) {
                ...
                if (SipConstants.DTMF_RELAY_SUNCONTENT_TYPE
                        .equals(contentSubType)) {
                    contentString = contentString.replace("\n",
                            System.getProperty("line.separator"));
                }

                contentReturned = new Content(mainContentType, contentSubType,
                        contentString);
