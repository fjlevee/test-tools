...
/**
 * 
 * This StartExtensionFileFilter filters Files with a Starts String and and
 * extension.
 * 
...
public class StartExtensionFileFilter implements FileFilter {
    ...
    public boolean accept(File file) {
        ...
        if (file.isDirectory())
            return true;
        if ((startWithString != null) && (!startWithString.isEmpty())
                && (!fileName.startsWith(startWithString))) {
            return false;
        }
        if (extensions != null) {
