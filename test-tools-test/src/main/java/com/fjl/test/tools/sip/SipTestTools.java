...
public final class SipTestTools {
     ...
     * 
     * @param replacesHeaderValue
     *            Specifies the Replaces Header value.<br>
     *            Its format can be Replaces: [CALL_ID] or Replaces:
     *            [CALL_ID];to-tag=[TO_TAG];from-tag=[FROM_TAG]
     * 
     * @return the Call Id Found in Replaces Header else null
     */
    public static String extractCallIdFromReplacesHeader(
     ...
     * 
     * @param direction
     *            Specifies the Direction as String.<br>
     * 
     * @return the message direction (TO_CLIENT or TO_SERVER)
     */
    public static ActionDirection getMessageDirection(
            String messageDirectionString) {
        ActionDirection messageDirection = ActionDirection.TO_CLIENT;
        if ((RECEIVED_DIRECTION.equals(messageDirectionString))
                || (TO_SERVER_DIRECTION.equals(messageDirectionString))) {
