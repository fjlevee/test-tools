...
public class HeaderElement {
    ...
    public void parseElement(MessageElement messageElement,
            org.w3c.dom.Node headerElement) throws SipClientParserException {

        // Get the xmlCallFlowElement attributes
        org.w3c.dom.NamedNodeMap xmlCallFlowNodesAttributes = headerElement
                .getAttributes();
        ...
        try {
            ...
            throw new SipClientParserException(
                    "HeaderElement.parseXmlCallFlowElement: name attribute can not be null");
        }
